...
const createMovieDataValidator = () => {
  return celebrate({
    body: Joi.object().keys({
...
const deleteMovieDataValidator = () => {
  return celebrate({
...
module.exports = { patchUserDataValidator, createMovieDataValidator, deleteMovieDataValidator };